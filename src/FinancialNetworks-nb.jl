...
using Makie.GeometryBasics: Rect, Vec2f0
...
# ╔═╡ 935f428c-325b-48b2-9133-6420666d3cbb
md"""
# Results
"""
...
function _balance_sheet_df_((; c, x, div, ill, rec, ν_paid, y_paid, shortfall))
	DataFrame([
		(color = "external",  side = "receivable", ill=false, val=c, lab=L"cash $c$"),
		(color = "interbank", side = "receivable", ill=false, val=x, lab=L"IB deposit $x$"),
...
julia_version = "1.9.2"
manifest_format = "2.0"
project_hash = "dec346662c063938008818611d1befc981725653"
...
git-tree-sha1 = "0330838ffb57a28b030259f7d02f01887de5d14d"
